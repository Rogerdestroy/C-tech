...
#include "Guids.h"
#include "..\test copliteUI\Resource.h"

#include "..\test copliteUI\CommandIds.h"
...
class ATL_NO_VTABLE Ctest_coplitePackage : 
	...
	public CComCoClass<Ctest_coplitePackage, &CLSID_test_coplite>,
	// Provides the implementation for IVsPackage to make this COM object into a VS Package.
	public IVsPackageImpl<Ctest_coplitePackage, &CLSID_test_coplite>,
	public IOleCommandTargetImpl<Ctest_coplitePackage>,
...
// the Ctest_coplitePackage object will support via QueryInterface
BEGIN_COM_MAP(Ctest_coplitePackage)
...
VSL_DECLARE_NOT_COPYABLE(Ctest_coplitePackage)

public:
	Ctest_coplitePackage()
	{
	}
...
// This exposes Ctest_coplitePackage for instantiation via DllGetClassObject; however, an instance
// can not be created by CoCreateInstance, as Ctest_coplitePackage is specifically registered with
// VS, not the the system in general.
OBJECT_ENTRY_AUTO(CLSID_test_coplite, Ctest_coplitePackage)
